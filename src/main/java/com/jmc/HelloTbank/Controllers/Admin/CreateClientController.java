...
public class CreateClientController implements Initializable {
    ...
    private void createClient(){
        ...
        error_lbl.setText("Tạo tài khoản thành công!");
        emtyField();
    }
    ...
    private void createAccount (String accountType){
        ...
        //tạo tk nguồn và tiết kiệm
        if (accountType.equals("Checking")){
            Model.getInstance().getDatabaseDriver().createCheckingAccount(payeeAddress, accountNumber, 50000, balance);
        } else {
